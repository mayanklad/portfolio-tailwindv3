...
function Experience() {  
  ...
  return (
    <div id='experience' className='experience-container px-2.5 md:px-[8.3%] xl:px-[16.6%] py-6 w-full bg-[#c4d6e2]'>
      <h1 className='px-3.5 max-md:underline underline-offset-[12px]'>Experience</h1>
