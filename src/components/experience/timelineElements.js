let timelineElements = [
    ...
    },
    {
      ...
      location: "Nuclear Power Corporation of India Limited - Tarapur, India",
      description:
        "During my internship, I underwent specialized training in web application development using the .NET framework. This experience focused on C# programming and MySQL backend integration, laying the groundwork for my journey into full-stack engineering.",
      buttonText: "",
      date: "June 2019",
      icon: "work",
    },
    {
      ...
      location: "Accenture Solutions Private Limited - Bengaluru, India",
      description:
